...
# CSV file paths
csv_file_1 = r'C:\Users\rjhar\Desktop\Practice\Figures\FeF3\241216-FeF3-ball_milled_24h-20-70deg-40min.csv'
csv_file_2 = r'C:\Users\rjhar\Desktop\Practice\Figures\FeF3\250205_20-70deg_40min_FeF3_as_received.csv'
FeF3 = r'C:\Users\rjhar\Desktop\Practice\Figures\FeF3\FeF3.csv'
...
df1['Scaled_Intensity'] = df1['Intensity']+5000
df2['Scaled_Intensity'] = df2['Intensity']-2000
...
plt.plot(df2['2Theta'], df2['Scaled_Intensity'], color='black', label=r'$FeF_3$ as Received')
plt.plot(df1['2Theta'], df1['Scaled_Intensity'], color='blue', label=r'$FeF_3$ Ball Milled')
