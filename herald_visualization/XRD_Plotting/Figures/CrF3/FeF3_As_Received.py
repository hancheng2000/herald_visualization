...
csv_file_2 = r'C:\Users\rjhar\Desktop\Practice\Figures\CrF3\250110-CrF3-as_received-20-70deg-40min.csv'
FeF3 = r'C:\Users\rjhar\Desktop\Practice\Figures\CrF3\CrF3.csv'
...
plt.plot(df2['2Theta'], df2['Scaled_Intensity'], color='black', label=r'$CrF_3$ as Received')
