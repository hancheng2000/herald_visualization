...
# CSV file paths
csv_file_1 = r'C:\Users\rjhar\Desktop\Practice\LiFeF2\250207-FeF2(LiF)-ball_milled_24h-20-70deg-40min.csv'
...
plt.plot(df1['2Theta'], df1['Scaled_Intensity'], label=r'$LiFeF_3$')
