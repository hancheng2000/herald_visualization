...
csv_file_2 = r'C:\Users\rjhar\Desktop\Practice\Figures\CoF3\20250212_20-70deg_40min_CoF3_as_received.csv'
FeF3 = r'C:\Users\rjhar\Desktop\Practice\Figures\CoF3\CoF3.csv'
...
plt.plot(df2['2Theta'], df2['Scaled_Intensity'], color='black', label=r'$CoF_3$ as Received')
