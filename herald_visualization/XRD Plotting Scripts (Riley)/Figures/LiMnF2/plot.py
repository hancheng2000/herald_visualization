...
# CSV file paths
csv_file_1 = r'C:\Users\rjhar\Desktop\Practice\LiMnF2\250207-MnF2(LiF)-ball_milled_24h-20-70deg-40min.csv'

LiF = r'C:\Users\rjhar\Desktop\Practice\LiMnF2\LiF.csv'
FeF2 = r'C:\Users\rjhar\Desktop\Practice\LiMnF2\MnF2.csv'
...
df1['Scaled_Intensity'] = df1['Intensity']+ 4000
...
plt.plot(df1['2Theta'], df1['Scaled_Intensity'], color= 'red', label=r'$LiMnF_3$')
